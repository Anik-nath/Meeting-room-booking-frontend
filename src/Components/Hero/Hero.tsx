  ...
  return (
    <div className="w-full bg-primary md:px-10 px-6 min-h-screen flex md:flex-row lg:flex-row flex-col justify-between gap-y-8 py-10 md:py-0 lg:py-0">
      <div className="w-full flex flex-col justify-center text-secondary">
        ...
        <h1 className="md:text-5xl text-4xl font-bold py-4">Book your ideal meeting room with ease.</h1>
        <h3 className="md:text-2xl text-xl mb-6">Efficient, hassle-free room booking for all your meeting needs.</h3>
        <div>
